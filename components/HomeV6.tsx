...
.cbtns{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-top:9px}
/* 오픈기념 한시 가격 안내 — 종료일이 눈에 보여야 미루지 않는다 */
.openbar{margin-top:10px;padding:7px 10px;border-radius:10px;background:#FFF6E3;
  border:1px solid #F1D9A4;text-align:center;font-size:11.3px;font-weight:700;
  color:#8A5A12;letter-spacing:-.035em;line-height:1.45}
.openbar s{opacity:.6;font-weight:600}
.openbar em{font-style:normal;font-weight:900;color:#B4451F;font-size:12.8px}
.cb-wide{grid-column:1 / -1}
.cb-open{background:linear-gradient(135deg,#1F6FE0,#1550B4);border:0;color:#fff;
...
.cb-quick{background:linear-gradient(135deg,#EEF5FF,#E0EDFF);border:1.5px solid #93C0F5;color:#1A4E9E;box-shadow:0 2px 8px rgba(29,109,227,.12)}
...
en: {
 ...
 ctaPro1:'Expert consultation', ctaPro2:'Reports from 9,900 KRW',
 ...
 sv4n:'AI element reading', sv4d:'Automatic reading of your result · instant',
 ...
 priceNote:'All four include the same 20-page report · only the consultation differs',
 ...
 sl1tag:'September launch event', sl1h:'AI element reading<br>launch price 990 KRW',
...
ja: {
 ...
 ctaPro1:'専門家に相談', ctaPro2:'レポート9,900ウォン〜',
 ...
 sv4n:'AI 五行解説', sv4d:'診断結果の自動解説 · すぐに発行',
 ctT:'👨‍🏫 専門家との1対1相談',
 ...
 priceNote:'レポートは4つとも同じ20枚です · 違いは相談方法だけです',
 ...
 sl1tag:'9月オープン記念', sl1h:'AI 五行解説<br>ローンチ価格 990ウォン',
...
zh: {
 ...
 ctaPro1:'专家咨询', ctaPro2:'报告 9,900韩元起',
 ...
 sv4n:'AI 五行解读', sv4d:'测试结果自动解读 · 即时发放',
 ctT:'👨‍🏫 专家一对一咨询',
 ...
 priceNote:'四种的报告完全相同，均为20页 · 区别只在咨询方式',
 ...
 sl1tag:'9月开业活动', sl1h:'AI 五行解读<br>上线价 990 韩元',
...
fr: {
 ...
 ctaPro1:"Consultation d'expert", ctaPro2:'Rapports dès 9 900 KRW',
 ...
 sv4n:'Lecture IA des cinq phases', sv4d:'Lecture automatique de votre résultat · immédiate',
 ...
 priceNote:'Les quatre formules incluent le même rapport de 20 pages · seule la consultation change',
 ...
 sl1tag:'Événement de lancement — septembre', sl1h:'Lecture IA des cinq phases<br>prix de lancement 990 KRW',
  ...
  <section>
    ...
    <div class="slides">
      <div class="slide">
        ...
        <h3 data-i="sl1h">AI 오행 해설<br>런칭가 990원</h3>
